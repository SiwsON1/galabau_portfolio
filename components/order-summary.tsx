    ...
    <Table className="w-1/2 mx-auto">
      ...
      <TableBody>
        ...
        <TableRow>
          ...
          <TableCell className="text-right">{formData.fenceSize} meter</TableCell>
        </TableRow>
        <TableRow>
          <TableCell>Länge</TableCell>
          <TableCell className="text-right">{formData.length} meter</TableCell>
        </TableRow>
        <TableRow>
        ...
        <TableRow>
          ...
          <TableCell className="text-right">
            {formData.gate === "none" ? "Kein Tor ausgewählt" : formData.gate}
          </TableCell>
        </TableRow>
        <TableRow>
